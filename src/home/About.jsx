      ...
      <div className="container grid md:grid-cols-2 m-auto gap-10 w-full p-5">
        <div className="container card bg-base-100 shadow-xl w-full">
          <div className="card-body glass">
            <h2 className="card-title dark:text-slate-300">Buy Accepted Brands</h2>
            <p className="font-normal text-base text-gray-700 dark:text-slate-300">
        ...
        <div className="card bg-base-100 shadow-xl w-full">
          <div className="card-body glass">
            <h2 className="card-titl dark:text-slate-300"> Sell Your Car</h2>
            <p className="font-normal text-base text-gray-700 dark:text-slate-300">
